        ...
        <div className="pane-content">
            ...
            {userNFTs?.total !== 0 && (
                <Alert
                    ...
                    showIcon
                    message={
                        "Approving a smart-contract comes with risks. We make our best to filter all scam NFTs, but some might still be left behind. Make sure not to approve any undesired Vehicles."
                    }
                />
            )}
            ...
            {userNFTs && userNFTs.total === 0 && (
                <Alert type="info" showIcon message={"No Cars found on this account"} />
            )}
